        ...
        <div className='w-[50%] border-l border-r border-gray-200'>
            <div>
                ...
                <div className='absolute top-52 ml-2 border-4 border-white rounded-full'>
                    <Avatar src={profile?.userImage || "https://pbs.twimg.com/profile_images/1703261403237502976/W0SFbJVS_400x400.jpg"} size="120" round={true} />
                </div>
                <div className='text-right m-4'>
                    {
                        profile?._id === user?._id ? (
                            <button className='px-4 py-1 hover:bg-[#d62965] rounded-full border border-white-400'>Edit Profile</button>
                        ) : (
